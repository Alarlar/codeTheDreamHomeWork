...
// PUT YOUR CODE HERE
function isDog(petObject) {
  let speciesChecker = "dog";
  return petObject.species === speciesChecker
}
console.log("Q4: ", isDog(myPet));
...
let library = [ {
...
},
   {
      ...
      author: 'Resig, Bibeault, and Maras',
      libraryID: 5729,
   },
       {
         title: 'The Tech That Comes Next',
...
let updatedLibrary = addTypeProperty(library);
console.log("Q6: ", addTypeProperty(library));
...
// PUT YOUR CODE HERE
function addNewObject(array, newObject) {
...
let newLibarary = addNewObject(library, {

...
// PUT YOUR CODE HERE
const names = ["Juan Marcos", "Aleksandra Ivanov", "Zhang Wei", "Bernice King"];
...
// PUT YOUR CODE HERE
const myNumbers = [1, 2, 7, 5, 8];

function totalPoints(numberList) {
  let total = 0;
...
const result1 = totalPoints(myNumbers);
console.log(result1);
...
// PUT YOUR CODE HERE
const myWords = ["You", "can", "if", "you", "think", "you", "can", "!"];
...
const result = buildSentence(myWords);
console.log(result); 
...
function logPercentages(decimalList) {
  decimalList.forEach(function(decimal) {
...
// PUT YOUR CODE HERE
const startingNums = [4, 41, 832, 72, 89];

function addThreeToAll(numberList) {
...
const result2 = addThreeToAll(startingNums);
console.log(result2); 
...
// PUT YOUR CODE HERE
const baseNums = [4, 41, 832, 72, 89];

function squareAll(numberList) {
  return numberList.map(function(number) {
...
const result3 = squareAll(baseNums);
console.log(result3); 
...
const names2 = ["Juan Marcos", "Aleksandra Ivanov", "Zhang Wei", "Bernice King"];

function allGreetings(nameList) {
...
const greetings = allGreetings(names2);
...
function pluck(objectList, key) {
  return objectList.map(function(obj) {
    return obj[key];
  });
}
const users3 = [
...
const usernames2 = pluck(users3, "username"); 
const isAdmins = pluck(users3, "isAdmin"); 
...
// PUT YOUR CODE HERE
function evenNumbers(numberList) {
  return numberList.filter(function(number) {
    return number % 2 === 0;
  });
}

const array = [4, 41, 832, 72, 89, 120, 431, 505, 70];
const evenNumbersArray = evenNumbers(array);
...
const exampleArray = [4, 41, 832, 72, 89, 120, 431, 505, 70];

function greaterThan100(numberList) {
  return numberList.filter(function(number) {
    return number > 100;
  });
}

const evenNumbersArray1 = evenNumbers(exampleArray);
const greaterThan100Array = greaterThan100(exampleArray);

console.log(evenNumbersArray1); 
...
// PUT YOUR CODE HERE
function nonAdminUsers(userList) {
...
const nonAdminList = nonAdminUsers(users4);
console.log(nonAdminList);
...
// PUT YOUR CODE HERE
function countAdminUsers(userList) {
  
  const adminUsers = userList.filter(function(user) {
    return user.isAdmin; // Concise check for admin status
  });
...
const numberOfAdmins = countAdminUsers(users5);
...
// PUT YOUR CODE HERE
function shorterThanX(stringList, maxLength) {
  return stringList.filter(function(string) {
...
const shortStrings1 = shorterThanX(strings, 20); 
const shortStrings2 = shorterThanX(strings, 30); 
console.log(shortStrings1, shortStrings2);
...
const manyTypes = [4, "4", "four score", 80, { age: 80 }, ["nations"], { type: "free" }, "states"];


const stringElements = onlyStrings(manyTypes);
...
// PUT YOUR CODE HERE
function firstOdd(numberList) {
  
  return numberList.find(function(number) {
    
    return number % 2 === 1;
  });
}

const array1 = [4, 41, 832, 72, 89, 120, 431, 505, 70];

const firstOddNumber = firstOdd(array1);
...
// PUT YOUR CODE HERE
function getAdministrator(userList) {
...
const administrator = getAdministrator(users6);
...
// PUT YOUR CODE HERE
function divisibleByTen(numberList) {
...
const array2 = [4, 41, 832, 72, 89, 120, 431, 505, 70];

const firstDivisibleByTen = divisibleByTen(array2);
...
// PUT YOUR CODE HERE
function divisibleByX(numberList, divisor) {
...
const numbers = [4, 41, 832, 72, 89, 120, 431, 70];


const firstDivisibleByTen1 = divisibleByX(numbers, 10);
console.log(firstDivisibleByTen); 

const firstDivisibleByThree = divisibleByX(numbers, 3);
console.log(firstDivisibleByThree); 

const firstDivisibleByTwo = divisibleByX(numbers, 2);
...
// PUT YOUR CODE HERE
function startsWithLetter(stringList, letter) {
  
  if (typeof letter !== "string" || letter.length !== 1) {
    throw new Error("Letter must be a string of length 1");
  }

  return stringList.find(function(string) {
    return string.toUpperCase()[0] === letter.toUpperCase();
  });
}
...
try {
  const firstStartingWithT = startsWithLetter(strings1, "T");
  console.log(firstStartingWithT); 

  const firstStartingWithI = startsWithLetter(strings1, "I");
  console.log(firstStartingWithI); 

  const firstStartingWithi = startsWithLetter(strings1, "i");
  console.log(firstStartingWithi); 
  startsWithLetter(strings1, "dog");
} catch (error) {

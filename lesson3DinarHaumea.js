...
function repeat(num) {
 // let i = 0;
  ...
  /*for (let i = 1; i <= num; i++) {
    // Code inside braces is run 3 times
     console.log(i); 
     console.log(`Hello World!`);
...
console.log("Q3:", noVowels("aAdveEntUrOuIs"));
...
// PUT YOUR CODE HERE
function vowelCount(someWords) {
  const vowels = ['a', 'e', 'i', 'o', 'u', 'A', 'E', 'I', 'O', 'U'];
  let count = 0;

  for (let i = 0; i < someWords.length; i++) {
    if (vowels.includes(someWords[i])) {
        count++;
          }
      }
  return count;
...
// PUT YOUR CODE HERE
let varible = ["dream", 19, "code", 24, 180];
...
function calculateTotalLoop(arr) {
    let total = 0;
...
function calculateTotalReduce(arr) {
    return arr.reduce((accumulator, currentValue) => accumulator + currentValue, 0);
}

console.log("Q10 (Loop): ", calculateTotalLoop(numbers));       
console.log("Q10 (Reduce): ", calculateTotalReduce(numbers));   
...
function findEvensFilter(arr) {
  return arr.filter(element => element % 2 === 0);
}

function findOddsFilter(arr) {
  return arr.filter(element => element % 2 !== 0);
}

const numbersArray = [10, 2, 3, 19, 7, 6, 93];

console.log("Q11 evens (Loop): ", findEvensLoop(numbersArray));       
console.log("Q11 odds (Loop): ", findOddsLoop(numbersArray));         

console.log("Q11 evens (Filter): ", findEvensFilter(numbersArray));   
console.log("Q11 odds (Filter): ", findOddsFilter(numbersArray));     
...
function makeSquaresMap(arr) {
  return arr.map(element => element ** 2);
}


const numbersArrays = [2, 5, 8];

console.log("Q12 (Loop): ", makeSquaresLoop(numbersArray));    
console.log("Q12 (Map): ", makeSquaresMap(numbersArray));      
